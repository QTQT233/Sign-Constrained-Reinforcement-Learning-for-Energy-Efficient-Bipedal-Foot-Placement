...
#     torch.load('D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_1624.pth'))
# model.load_state_dict(
#     torch.load('D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_critic_1624.pth'))
model.to(device)
policy.to(device)
# model.train()
...
for epoch in range(episode):
    ...
    if epoch > 1:
        ...
        if ini_a >= ini_b:
            torch.save(policy.state_dict(),
                       f'D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_{ini_a}.pth')
            torch.save(model.state_dict(),
                       f'D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_critic_{ini_a}.pth')
            if os.path.exists(
                    f'D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_{ini_b}.pth'):
                os.remove(f'D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_{ini_b}.pth')
            if os.path.exists(
                    f'D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_critic_{ini_b}.pth'):
                os.remove(f'D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_critic_{ini_b}.pth')
            # torch.save(policy.state_dict(),
            #            f'D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_{ini_a}.pth')
            # torch.save(model.state_dict(),
            #            f'D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_critic_{ini_a}.pth')
    ...
    torch.save(policy.state_dict(),
               f'D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_step1.pth')
    torch.save(model.state_dict(),
               f'D:/L&S/Mas/Project/Paper2/l1_stand(0,1)_critic.pth')
