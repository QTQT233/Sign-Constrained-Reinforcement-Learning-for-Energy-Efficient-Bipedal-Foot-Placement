...
persistence in the frozen two-class-selector evaluation. It does not establish
that persistence reduces conditional `Cmt`. These 419 both-valid hold/requery
pairs are distinct from the 427 active-PPO/three-expert-selector both-valid
pairs in the current primary benchmark.
