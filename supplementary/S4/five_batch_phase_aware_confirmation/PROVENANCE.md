...
## Gate and analysis-source amendment

The five-batch analyzer loads the released three-expert gate and applies
phase-specific confidence thresholds to its three-class probabilities. The
original frozen protocol omitted the gate from its `frozen_sha256` dictionary,
although the generated final report recorded the checkpoint hash. The original
protocol and report remain unchanged. `GATE_HASH_AMENDMENT_02.json` binds the
gate checkpoint to the recorded result and documents that this metadata repair
does not change any scientific operation.

The final report also records the execution-time analysis source hash
`e359767129ddf5dae311792a96505db731034daa60c127353e88226f1167f52e`.
The portable release analysis source has hash
`f2ab5e688e90d820dd0bc9c39caf3840c8f2d921fb29a5916ceb7126b30a48de`
before the device-portability repair and
`39a958ed5dc43151f249993beb9d728948ca8a0913743086e698cb899f089684`
after that repair. The amendment records this source boundary. The published
matched record and manuscript-metric builder provide the output-level
verification path for every reported aggregate.
