...
policy.load_state_dict(
    torch.load('D:/L&S/Mas/Project/Paper2/l2_stand_continuous_1159.pth'))
# model.load_state_dict(
#     torch.load('D:/L&S/Mas/Project/Paper2/l2_stand_continuous_critic_1624.pth'))
model.to(device)
policy.to(device)
# model.train()
optimizer_value = torch.optim.Adam(model.parameters(), lr=5e-5)
optimizer_policy = torch.optim.Adam(policy.parameters(), lr=5e-5)
...
for epoch in range(episode):
    ...
    if epoch > 1:
        ...
        if ini_a >= ini_b:
            torch.save(policy.state_dict(),
                       f'D:/L&S/Mas/Project/Paper2/l2_stand_continuous_{ini_a}.pth')
            torch.save(model.state_dict(),
                       f'D:/L&S/Mas/Project/Paper2/l2_stand_continuous_critic_{ini_a}.pth')
            if os.path.exists(
                    f'D:/L&S/Mas/Project/Paper2/l2_stand_continuous_{ini_b}.pth'):
                os.remove(f'D:/L&S/Mas/Project/Paper2/l2_stand_continuous_{ini_b}.pth')
            if os.path.exists(
                    f'D:/L&S/Mas/Project/Paper2/l2_stand_continuous_critic_{ini_b}.pth'):
                os.remove(f'D:/L&S/Mas/Project/Paper2/l2_stand_continuous_critic_{ini_b}.pth')
            # torch.save(policy.state_dict(),
            #            f'D:/L&S/Mas/Project/Paper2/l2_stand_continuous_{ini_a}.pth')
            # torch.save(model.state_dict(),
            #            f'D:/L&S/Mas/Project/Paper2/l2_stand_continuous_critic_{ini_a}.pth')
    ...
    torch.save(policy.state_dict(),
               f'D:/L&S/Mas/Project/Paper2/l2_stand_continuous_step1.pth')
    torch.save(model.state_dict(),
               f'D:/L&S/Mas/Project/Paper2/l2_stand_continuous_critic.pth')
