...
| Table V | `results/two_link_primary_12_cases.csv`; `analysis/reproduce_paper2_tables.py` | all 12 case values reproduced | retain case-level rows rather than four condition means only |
