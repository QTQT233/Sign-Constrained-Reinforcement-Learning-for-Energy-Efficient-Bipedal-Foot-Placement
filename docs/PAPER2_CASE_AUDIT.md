...
|---|---|---:|---|
| Proposed one-sided selector | `Qi_multi_passive_sim.py` | 12/12 | complete; the legacy filename is retained; landing residual is missing in one case |
...
| Proposed one-sided selector | 12 | 0.123473 | 0.010531 | [0.116782, 0.130164] | 2.797 | 0.082750 (n=11) |
