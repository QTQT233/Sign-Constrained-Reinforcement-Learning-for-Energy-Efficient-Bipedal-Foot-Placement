...
with h5py.File('D:/L&S/Mas/Project/Paper2/working_l1_stand_save_passive_1(-1,0,1)-30,60', 'w') as h5f:
    h5f.create_dataset('working_save_passive', data=working_save_passive)
with h5py.File('D:/L&S/Mas/Project/Paper2/reward_check_l1_stand_passive_1(-1,0,1)-30,60', 'w') as h5f:
