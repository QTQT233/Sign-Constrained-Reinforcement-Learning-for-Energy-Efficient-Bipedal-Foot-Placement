...
while step != 0:
    ...
    if reward1:
        ...
        Energy_pre = kinetic_energy(state[0], state[2], state[1], state[3], params)
        print(f"碰撞前E：Energy_pre= {Energy_pre:.4f}")
        ...
        print(f"碰撞后E：Energy_new= {Energy_new:.4f}")
        print(f"碰撞E_loss= {Energy_new - Energy_pre:.4f}")
        # 输出结果（转换为度便于观察）
        print("碰撞后新状态（新定义）：")
...
_replay = {
    ...
    "push_off_1_rad_s": 0.91,
    "push_off_2_rad_s": 0.86,
    ...
    "source_fixed_sha256": '8ac7a07c8bd147d519a60f392b5f9026bbf56f81d193946386d402bde17e3487',
    "old_push_off_1_rad_s": 0.91,
    "old_push_off_2_rad_s": 0.86,
    "search_cmt": 0.22497154385730195,
    "search_energy_J": 6.6819957640281045,
    "search_com_displacement_m": 1.3479660526724486,
}
