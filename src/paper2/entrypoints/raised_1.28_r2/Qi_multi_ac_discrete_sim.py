...
def handle_collision(state_fun, stance_leg_fun, params_fun, energy_ac_discrete_fun):
    ...
    if stance_leg_fun == 1:
        dtheta1_new_fun -= 0.81
    else:
        dtheta1_new_fun -= 1.13
...
_replay = {
    ...
    "push_off_1_rad_s": 0.81,
    "push_off_2_rad_s": 1.1300000000000001,
    ...
    "source_fixed_sha256": '13c06012563772f835c6a6fb439cbb654afea05f924410c73bcf7f694220f26b',
    "old_push_off_1_rad_s": 0.81,
    "old_push_off_2_rad_s": 1.13,
    "search_cmt": 0.22253973480066636,
    "search_energy_J": 6.415906850357675,
    "search_com_displacement_m": 1.308431019345505,
}
