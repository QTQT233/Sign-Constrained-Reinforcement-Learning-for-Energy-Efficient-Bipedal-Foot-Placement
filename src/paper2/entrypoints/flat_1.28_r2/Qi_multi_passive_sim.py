...
def handle_collision(state_fun, stance_leg_fun, params_fun, energy_passive_fun):
    ...
    if stance_leg_fun == 1:
        dtheta1_new_fun -= 0.44
    else:
        dtheta1_new_fun -= 0.71
...
_replay = {
    ...
    "case_id": 'flat_1.28_r2',
    "controller": 'passive',
    "seed": int(CMT_REPLAY_SEED),
    "push_off_1_rad_s": 0.44,
    "push_off_2_rad_s": 0.71,
    ...
    "source_fixed_sha256": '13e7b05eea26a7f32959cc12daa1d7b59cf5d7d2a1efd1ac708ec3e0ba46c867',
    "old_push_off_1_rad_s": 0.44,
    "old_push_off_2_rad_s": 0.71,
    "search_cmt": 0.11225498534642357,
    "search_energy_J": 3.4192043092780655,
    "search_com_displacement_m": 1.38235555582163,
}
