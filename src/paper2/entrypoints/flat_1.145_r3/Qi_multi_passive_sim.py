...
def handle_collision(state_fun, stance_leg_fun, params_fun, energy_passive_fun):
    ...
    if stance_leg_fun == 1:
        dtheta1_new_fun -= 0.61
    else:
        dtheta1_new_fun -= 0.59
...
_replay = {
    ...
    "case_id": 'flat_1.145_r3',
    "controller": 'passive',
    "seed": int(CMT_REPLAY_SEED),
    "push_off_1_rad_s": 0.61,
    "push_off_2_rad_s": 0.59,
    ...
    "source_fixed_sha256": '368a3f5686d15500a457d771954a50a56e084b90dcadd9b671e8736ab37198e4',
    "old_push_off_1_rad_s": 0.61,
    "old_push_off_2_rad_s": 0.59,
    "search_cmt": 0.12143080143077968,
    "search_energy_J": 3.2177259709112502,
    "search_com_displacement_m": 1.202598179750182,
}
