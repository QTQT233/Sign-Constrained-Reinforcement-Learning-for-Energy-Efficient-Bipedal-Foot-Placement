...
def load_policy_and_env(stance_leg_fun, params1, params2):
    ...
    if stance_leg_fun == 1:
        params_fun = params1
        policy_path = _resolve_artifact(__file__, "l1_stand(-1,0,1)_1452.pth")
        actions_fun = [-1, 0, 1]

    else:
        params_fun = params2
        policy_path = _resolve_artifact(__file__, "l2_stand(-1,0,1)_1558.pth")
        actions_fun = [-1, 0, 1]
...
_replay = {
    ...
    "push_off_1_rad_s": 0.6900000000000001,
    "push_off_2_rad_s": 1.1400000000000001,
    ...
    "source_fixed_sha256": '198685c8270ca3436f15ce346928748a4397e213a814172c959eaa41a4875d5b',
    "old_push_off_1_rad_s": 0.69,
    "old_push_off_2_rad_s": 1.14,
    "search_cmt": 0.24133085679392913,
    "search_energy_J": 6.235974799856348,
    "search_com_displacement_m": 1.1727132832785898,
}
