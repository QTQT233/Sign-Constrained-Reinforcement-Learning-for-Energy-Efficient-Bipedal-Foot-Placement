...
def handle_collision(state_fun, stance_leg_fun, params_fun, energy_ac_discrete_fun):
    ...
    if stance_leg_fun == 1:
        dtheta1_new_fun -= 0.72
    else:
        dtheta1_new_fun -= 0.99
...
_replay = {
    ...
    "source_fixed_sha256": '2329016e659f9012977827c5f63384010147451c2d2b35da4778783bebaec1da',
    "old_push_off_1_rad_s": 0.72,
    "old_push_off_2_rad_s": 0.99,
    "search_cmt": 0.2171195951298242,
    "search_energy_J": 6.386975722348525,
    "search_com_displacement_m": 1.335047114878377,
}
