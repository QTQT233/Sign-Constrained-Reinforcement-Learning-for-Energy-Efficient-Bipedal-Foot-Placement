...
policy.load_state_dict(torch.load('C:/Users/Admin/Desktop/paper-code - F/Policy_Net_Pytorch(1,0)_900.pth'))
policy.to(device)
            ...
            for ll in range(N2):
                ...
                for step in range(steps):
                    ...
                    if (abs(y[0] - theta1_target1) < settle and abs(y[2] - theta2_target1) < settle) or \
                        ...
                        flag = 1
                        break
with h5py.File('C:/Users/Admin/Desktop/paper-code - F/working_save(0,1)-10,30_from2-2', 'w') as h5f:
