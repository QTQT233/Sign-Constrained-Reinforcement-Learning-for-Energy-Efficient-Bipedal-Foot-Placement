...
policy_active_continuous.load_state_dict(
    torch.load(f'D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.04/60,30(0.33m),0.01m/'
...
policy_passive_discrete.load_state_dict(torch.load
                                        (f'D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.04/60,30(0.33m),0.01m/'
...
with h5py.File('D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.04/60,30(0.33m),0.01m/working_save_passive-10-30', 'w') as h5f:
    h5f.create_dataset('working_save_passive', data=working_save_passive)
with h5py.File('D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.04/60,30(0.33m),0.01m/Cmt_save_passive-10-30', 'w') as h5f:
...
with h5py.File('D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.04/60,30(0.33m),0.01m/Energy_save_active_discrete-10-30', 'w') as h5f:
...
with h5py.File('D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.04/60,30(0.33m),0.01m/Energy_save_active_continuous-10-30', 'w') as h5f:
