...
policy_active_continuous.load_state_dict(
    torch.load('D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.06/60,30(0.33m)/'
...
policy_passive_discrete.load_state_dict(torch.load
                                        ('D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.06/'
                                         '60,30(0.33m)/Policy_Net_Pytorch(1,0)_823.pth'))
policy_passive_discrete.to(device)
policy_passive_discrete_1.load_state_dict(torch.load
                                          ('D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.06/'
                                           '60,30(0.33m)/Policy_Net_Pytorch(-1,0)_821.pth'))
policy_passive_discrete_1.to(device)
policy_active_discrete.load_state_dict(torch.load
                                       ('D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.06/60,30(0.33m)/'
