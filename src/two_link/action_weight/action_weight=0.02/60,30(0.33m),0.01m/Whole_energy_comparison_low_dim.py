...
policy_active_continuous.load_state_dict(
    torch.load('D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.02/60,30(0.33m),0.01m/'
...
policy_passive_discrete.load_state_dict(torch.load
                                        ('D:/L&S/Mas/Project/Paper1/Energy_Comparison/action_weight=0.02/60,30(0.33m),0.01m/'
