...
#     torch.load('D:/L&S/Mas/Project/Paper2/l1_stand(-1,0,1)_critic_1624.pth'))
model.to(device)
policy.to(device)
# model.train()
...
class PendulumEnv:
    ...
    def reset(self):
        ...
        #     theta_1_initial = tht1s[19]
        #     theta_2_initial = tht2s[15]
        #     theta_1_dot_initial = dtht1s[11]
        #     theta_2_dot_initial = dtht2s[7]
        # else:
...
def play():
    ...
    while not over_:
        ...
        prob_ = policy(torch.FloatTensor(state_in_net_).reshape(1, 4).to(device))[0].cpu().detach().numpy()
...
for epoch in range(episode):
    ...
    if epoch > 1:
        ...
        if ini_a >= ini_b:
            torch.save(policy.state_dict(),
                       f'D:/L&S/Mas/Project/Paper2/l1_stand(-1,0,1)_{ini_a}.pth')
            torch.save(model.state_dict(),
                       f'D:/L&S/Mas/Project/Paper2/l1_stand(-1,0,1)_critic_{ini_a}.pth')
            if os.path.exists(
                    f'D:/L&S/Mas/Project/Paper2/l1_stand(-1,0,1)_{ini_b}.pth'):
                os.remove(f'D:/L&S/Mas/Project/Paper2/l1_stand(-1,0,1)_{ini_b}.pth')
            if os.path.exists(
                    f'D:/L&S/Mas/Project/Paper2/l1_stand(-1,0,1)_critic_{ini_b}.pth'):
                os.remove(f'D:/L&S/Mas/Project/Paper2/l1_stand(-1,0,1)_critic_{ini_b}.pth')
            # torch.save(policy.state_dict(),
            #            f'D:/L&S/Mas/Project/Paper2/l1_stand(-1,0,1)_{ini_a}.pth')
            # torch.save(model.state_dict(),
            #            f'D:/L&S/Mas/Project/Paper2/l1_stand(-1,0,1)_critic_{ini_a}.pth')
    ...
    torch.save(policy.state_dict(),
               f'D:/L&S/Mas/Project/Paper2/l1_stand(-1,0,1)_step1.pth')
    torch.save(model.state_dict(),
               f'D:/L&S/Mas/Project/Paper2/l1_stand(-1,0,1)_critic.pth')
